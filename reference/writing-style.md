...
2. Never announce what you are doing. Delete "Let me...", "Now I'll...",
   "I'm going to...", "We'll now...". Do the thing; the reader sees it.
3. Honesty is assumed. Delete "honestly", "to be honest", "frankly",
   "truthfully", "candidly". If a message carries weight, carry it with
   grounded, specific language, not an intensity marker.
4. "Actually" must be materially required, meaning the sentence is
   wrong or misleading without it. Same standard for "basically",
   "essentially", "simply", "just".
5. Minimize verbosity. Cut a word if the sentence survives without it.
   One idea per sentence. Short sentences carry urgent facts best.

## Common tells to strip
